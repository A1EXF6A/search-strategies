...
def main() -> None:
    ...
    print("Posicion del agente: A")
    print("Posicion del objetivo: K")
    ...
    optimal_path, all_solutions, tree, metrics = strategy.run("A", "K", MAX_X, MAX_Y)
